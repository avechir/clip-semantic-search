    ...
    def __init__(self, dotenv_path: str = ".env", model = "gemini-3.5-flash-lite"):
        ...
        self.prompt = ChatPromptTemplate([
            ("system",
                ...
                "2. HANDLE NEGATIONS: If the user excludes an object ('not X', 'without X'):\n"
                "   - NEVER include the excluded word X in your output.\n"
                "   - NEVER use negation words like 'no', 'not', 'without', 'except' in the output.\n"
                "   - DO NOT replace X with visually similar lookalikes.\n"
                "   - Focus ONLY on positive descriptions: environment, setting, and alternative distinct objects.\n"
